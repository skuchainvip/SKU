...
type
  ...
  TSkuchainRecordWriterTest = class(TObject)
  private
  ...
  [TestFixture('MBW_Records')]
  TSkuchainArrayOfRecordWriterTest = class(TObject)
  private
    FMBW: IMessageBodyWriter;
    FJSONMediaType: TMediaType;
    FOutputStream: TStringStream;
...
{ TSkuchainRecordWriterTest }

procedure TSkuchainRecordWriterTest.Setup;
begin
  FMBW := GetRecordMBW;
...
procedure TSkuchainRecordWriterTest.TearDown;
begin
  FMBW := nil;
  FJSONMediaType.Free;
  FOutputStream.Free;
...
procedure TSkuchainRecordWriterTest.Nested;
var
  LRecordValue: TValue;
...
procedure TSkuchainRecordWriterTest.PrimitiveTypes;
var
...
procedure TSkuchainRecordWriterTest.Simple;
var
...
{ TSkuchainArrayOfRecordWriterTest }

procedure TSkuchainArrayOfRecordWriterTest.Setup;
begin
...
procedure TSkuchainArrayOfRecordWriterTest.TearDown;
begin
  FMBW := nil;
  FJSONMediaType.Free;
  FOutputStream.Free;
...
procedure TSkuchainArrayOfRecordWriterTest.Empty;
var
  LValue: TValue;
  LJSONArr: TJSONArray;
begin
...
procedure TSkuchainArrayOfRecordWriterTest.Items;
var
  LValue: TValue;
  LJSONArr: TJSONArray;
  LJSONObj: TJSONObject;
...
procedure TSkuchainArrayOfRecordWriterTest.NestedArrays;
var
...
procedure TSkuchainArrayOfRecordWriterTest.NestedRecords;
var
  LValue: TValue;
  LJSONArr: TJSONArray;
  LJSONObj: TJSONObject;
...
procedure TSkuchainArrayOfRecordWriterTest.SingleItem;
var
  LValue: TValue;
  LJSONArr: TJSONArray;
  LJSONObj: TJSONObject;
...
initialization
  TDUnitX.RegisterTestFixture(TSkuchainRecordWriterTest);
  TDUnitX.RegisterTestFixture(TSkuchainArrayOfRecordWriterTest);
