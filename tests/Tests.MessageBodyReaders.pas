...
type
  ...
  TSkuchainRecordReaderTest = class(TObject)
  private
  ...
  [TestFixture('MBR_Records')]
  TSkuchainArrayOfRecordReaderTest = class(TObject)
  private
    FMBR: IMessageBodyReader;
    FJSONMediaType: TMediaType;
...
{ TSkuchainRecordReaderTest }

procedure TSkuchainRecordReaderTest.Nested;
var
  LValue: TOuterRecord;
  LData: TBytes;
begin
...
procedure TSkuchainRecordReaderTest.PrimitiveTypes;
var
...
procedure TSkuchainRecordReaderTest.Simple;
var
...
procedure TSkuchainRecordReaderTest.Setup;
begin
  FMBR := GetRecordMBR;
...
procedure TSkuchainRecordReaderTest.TearDown;
begin
  FMBR := nil;
  FJSONMediaType.Free;
end;

{ TSkuchainArrayOfRecordReaderTest }

procedure TSkuchainArrayOfRecordReaderTest.Empty;
var
...
procedure TSkuchainArrayOfRecordReaderTest.Items;
var
...
procedure TSkuchainArrayOfRecordReaderTest.NestedArrays;
var
...
procedure TSkuchainArrayOfRecordReaderTest.NestedRecords;
var
...
procedure TSkuchainArrayOfRecordReaderTest.SingleItem;
var
  LValue: TArray<TPersonRecord>;
  LData: TBytes;
begin
...
procedure TSkuchainArrayOfRecordReaderTest.Setup;
begin
...
procedure TSkuchainArrayOfRecordReaderTest.TearDown;
begin
  FMBR := nil;
  FJSONMediaType.Free;
end;
...
initialization
  TDUnitX.RegisterTestFixture(TSkuchainRecordReaderTest);
  TDUnitX.RegisterTestFixture(TSkuchainArrayOfRecordReaderTest);
