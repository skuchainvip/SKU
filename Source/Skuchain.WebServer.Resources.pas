...
*)
unit Skuchain.WebServer.Resources;
...
type
  ...
  protected
    ...
    procedure ServeFileContent(const AFileName: string; const AResponse: TSkuchainResponse); virtual;
    procedure ServeDirectoryContent(const ADirectory: string; const AResponse: TSkuchainResponse); virtual;
  ...
  public
    ...
    // REST METHODS
    [GET, Path('/{*}')]
    function GetContent: TSkuchainResponse; virtual;
...
function TFileSystemResource.GetContent: TSkuchainResponse;
var
  LRelativePath: string;
  LFullPath: string;
  LIndexFileFullPath: string;
begin
  Result := TSkuchainResponse.Create;
...
procedure TFileSystemResource.ServeDirectoryContent(const ADirectory: string;
  const AResponse: TSkuchainResponse);
var
